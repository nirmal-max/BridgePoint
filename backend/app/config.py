...
# Commission
COMMISSION_RATE_EMPLOYER: float = float(os.getenv('COMMISSION_RATE_EMPLOYER', '0.0'))
COMMISSION_RATE_LABOR: float = float(os.getenv('COMMISSION_RATE_LABOR', '0.0'))
COMMISSION_RATE_PLATFORM: float = 0.0
