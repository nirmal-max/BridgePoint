...
if JWT_SECRET_KEY == _DEFAULT_SECRET:
    _logger.warning("⚠️  JWT_SECRET_KEY is set to the default dev value! Set JWT_SECRET_KEY in production.")
